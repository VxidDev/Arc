...
if get_os() == "Linux" then
  var __net__ = dl_open(stdlib_path() + "/clib/libarcnet.so")
elif get_os() == "MacOS" then
  var __net__ = dl_open(stdlib_path() + "/clib/libarcnet.dylib")
elif get_os() == "Windows" then
  var __net__ = dl_open(stdlib_path() + "\\clib\\libarcnet.dll")
else 
